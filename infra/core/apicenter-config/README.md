...
| <a name="input_apim_import_specification"></a> [apim\_import\_specification](#input\_apim\_import\_specification) | Whether to import the specification file along with metadata for APIs synchronized from API Management. One of: always, never, ondemand. | `string` | `"always"` | no |
